...
import Factory.PizzaFactory.ChicagoPizzaStore;
import Factory.PizzaFactory.NYPizzaStore;
...
public class Factory
{
    public static void main(String[] args)
    {
        ...
        System.out.println("披萨已制作好：" + np.getName());
        System.out.println("披萨已制作好："+cc.getName());
    }
}
